    ...
    fieldsCfg(){
        ...
        for(const field of Object.keys(this.form.value.fields)){
            ...
            if(hasKey(fcfg, "value")){
                fcfg["value"] = computed(()=>{
                    return this.data.value ? this.data.value[field] : null;
                });
            }
            if(hasKey(fcfg, "modelValue")){
                fcfg["modelValue"] = computed(()=>{
                    return this.data.value ? this.data.value[field] : null;
                });
            }
            ret[field] = fcfg;
...
export class QuasarFormConfig extends BaseFormConfig{
    fieldCfg(fname){
        ...
        const errors = computed(()=>{
            if(this.errors.value && this.errors.value[fname] && this.errors.value[fname].length){
                return this.errors.value[fname].join("; ");
            }
            return null;
        });
        res["error-message"] = errors;
        res["error"] = computed(function(){
