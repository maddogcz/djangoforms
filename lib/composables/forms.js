...
import {BaseFormConfig} from "./cfg.js";

export function setFormCfg(cfg){
    window._DJANGOFORMS_DEFAULT_CFG = cfg;
}
...
export function form(form, cfgExtend=null, formCfg=null){
    formCfg = formCfg || window._DJANGOFORMS_DEFAULT_CFG || BaseFormConfig;
...
export function formset(form, data, errors, emit, extend=null, formCfg=null){
    formCfg = formCfg || window._DJANGOFORMS_DEFAULT_CFG || BaseFormConfig;
...
export function formsetValues(form, formCfg=null){
    formCfg = formCfg || window._DJANGOFORMS_DEFAULT_CFG || BaseFormConfig;
    const data = ref([]);
    const errors = ref([]);
